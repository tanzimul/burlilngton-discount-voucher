...
<head>
    ...
    <title>Senior Discount Voucher</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <table cellspacing="3" cellpadding="0" border="0" align="center" style="width:100%;" bgcolor="#FFFFFF">
        ...
        <tr>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0" align="center" style="width:100%;" bgcolor="#FFFFFF">
                                <tr>
                                    <td colspan="2" align="left" valign="middle" style="padding:5px;">
                                        <p style="font-family:Calibri Bold,sans-serif;font-size: 26px;line-height: 26px;margin:0;padding:0;">{{ $code }} {{ $data['first_name'] }}, {{ $data['last_name'] }}</p>
                                    </td>
                                </tr>
                                <tr>
            ...
            @else
            <td align="center" valign="middle" style="padding:5px;">
                <table width="360" cellspacing="0" cellpadding="0" border="1" align="center" style="max-width:360px;width:100%;">
                    <tr>
                        <td align="center" valign="middle" style="padding:5px;">
                            <table cellspacing="0" cellpadding="0" border="0" align="center" style="width:100%;" bgcolor="#FFFFFF">
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="center" valign="middle" style="padding:5px;">
                                        <img src="{{ public_path().'/images/senior-button.png' }}" width="130" height="45" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="middle" style="padding:5px;">
